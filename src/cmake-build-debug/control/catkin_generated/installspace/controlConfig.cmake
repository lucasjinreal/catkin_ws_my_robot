...
if("FALSE" STREQUAL "TRUE")
  ...
  set(control_DEVEL_PREFIX /media/jintain/wd/ros/wps/catkin_ws_my_robot/src/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/media/jintain/wd/ros/wps/catkin_ws_my_robot/devel/lib;/opt/ros/melodic/lib)
