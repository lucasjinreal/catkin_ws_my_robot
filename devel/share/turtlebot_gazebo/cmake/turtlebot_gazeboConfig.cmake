...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/src/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/src/turtlebot_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/devel/lib;/opt/ros/melodic/lib)
