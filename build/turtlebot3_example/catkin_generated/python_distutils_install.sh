...
echo_and_run cd "/media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/src/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/src/turtlebot3_example/setup.py" \
    build --build-base "/media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/build/turtlebot3_example" \
    install \
    $DESTDIR_ARG \
