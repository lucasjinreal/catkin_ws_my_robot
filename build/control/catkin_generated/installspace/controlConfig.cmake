...
if("FALSE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/src/control)
  set(control_DEVEL_PREFIX /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'jintain <jintain@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/install/lib;/media/jintain/sg/ai/career/robot/ctirobot/ros_sp/catkin_ws_my_robot/devel/lib;/opt/ros/melodic/lib)
